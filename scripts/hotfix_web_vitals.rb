#!/usr/bin/env ruby
# Hotfix for web_vitals rpush error - June 29, 2026

puts "🔧 Hotfix: Fixing RedisService method calls in web_vitals"
puts "=" * 60
...
puts "✅ Fixed web_vitals.rb to use RedisService.with_redis"
puts ""
